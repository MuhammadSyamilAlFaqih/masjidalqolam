...
const photos = Array.from({ length: 18 }, (_, i) =>
  `https://res.cloudinary.com/dsm3bygd8/image/upload/f_auto,q_auto,w_1600/pemuda/${String(i + 1).padStart(3, "0")}`
);
    ...
    <>
      <div className="relative flex flex-col min-h-screen bg-white overflow-hidden">
        ...
        <div className="relative text-center pt-28 md:pt-32 mb-8 px-4">
          ...
          <h1 className="text-2xl md:text-4xl font-extrabold text-gray-900 font-[merriweather]">Pemuda</h1>
